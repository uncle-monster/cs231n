...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        x_input = word_embedding_forward(captions_in,W_embed)
        hidden_state = rnn_forward(x_input,h0,Wx,Wh,b)
        scores = temporal_affine_forward(hidden_state,W_vocab,b_vocab)
    ...
    def sample(self, features, max_length=30):
        ...
        for t in range(0,max_length):
            prev_word_embedding = word_embedding_forward(prev_word,W_embed)
            next_h = rnn_step_forward(prev_word_embedding,prev_h,Wx,Wh,b)
